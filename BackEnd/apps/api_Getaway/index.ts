...
//     // Start HTTP Server with auto port fallback
...
// //         console.log(
// //           `[API Gateway] Port ${port} is in use, trying ${port + 1}...`,
// //         );
// //         startServer(port + 1);
// //       } else {
...
// // httpServer.listen(PORT.SERVICES_PORTS.API_GETAWAY, () => {
// //   console.log(
// //     `api gateway is running on port ${PORT.SERVICES_PORTS.API_GETAWAY}`,
// //   );
// // });
// // -------------------- GRACEFUL SHUTDOWN --------------------
